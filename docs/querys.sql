...
('Ferragens', 'Ferramentas manuais e elétricas.', 'https://example.com/tools.jpg'),
('Pintura', 'Tintas de várias cores e usos.', 'https://example.com/paints.jpg'),
('Eletrica', 'Fios, cabos e equipamentos para instalações elétricas.', 'https://example.com/electrical.jpg'),
('Segurança', 'Equipamentos de Proteção Individual.', 'https://example.com/epi.jpg'),
('Construção', 'Materiais e ferramentas para construção civil.', 'https://example.com/construction.jpg'),
('Suvinil', 'Tintas de várias cores e usos.', 'https://example.com/suvinil.jpg'),
...
('Glasu', 'Materiais e acabamentos com qualidade Glasu.', 'https://example.com/glasu.jpg'),
('Promoção', 'Ofertas e descontos especiais em diversos produtos.', 'https://example.com/promocao.jpg');
...
('Cimento Queimado', 25.00, 100, 'Cimento queimado Suvinil, ideal para acabamentos modernos e sofisticados.', 'https://i.imgur.com/tf72Ovl.jpeg', 60, 20, 6, CURRENT_TIMESTAMP),
('Lona Plástica Azul', 89.90, 150, 'Lona plástica azul ultra resistente, indicada para coberturas, reformas e proteção.', 'https://i.imgur.com/nwBLFe3.jpeg', 25, 8, 7, CURRENT_TIMESTAMP),
('Tubo de PVC', 12.50, 300, 'Tubo de PVC padrão para sistemas hidráulicos, garantindo durabilidade e fácil instalação.', 'https://i.imgur.com/UgrwYJn.jpeg', 45, 18, 8, CURRENT_TIMESTAMP),
('Eco-Primer', 8.99, 500, 'Eco-Primer de rápida secagem, ideal para preparar superfícies antes da pintura.', 'https://i.imgur.com/XluF48U.jpeg', 15, 3, 2, CURRENT_TIMESTAMP),
...
('Torneira Esfera Fluida', 25.99, 120, 'Torneira esfera de 1/2", modelo fluida, prática e eficiente para instalações hidráulicas.', 'https://i.imgur.com/oe1WWyP.jpeg', 20, 10, 8, CURRENT_TIMESTAMP);
